...
class VaultNotifier extends _$VaultNotifier {
  ...
  Future<bool> activate(String masterPassword) async {
    ...
    try {
      ...
      await settingsService.setBool(_kVaultEnabled, value: true);
  ...
  Future<bool> enableBiometry() async {
    ...
    try {
      ...
      await settingsService.setBool(_kVaultBiometryEnabled, value: true);
  ...
  Future<void> disableBiometry() async {
    try {
      ...
      await settingsService.setBool(_kVaultBiometryEnabled, value: false);
