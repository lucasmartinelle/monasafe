...
class OnboardingController extends _$OnboardingController {
  ...
  void setWantsCheckingAccount({required bool wants}) {
  ...
  void setWantsSavingsAccount({required bool wants}) {
    state = state.copyWith(
  ...
  Future<bool> completeOnboarding() async {
    ...
    try {
      ...
      await settingsRepo.setIsAnonymous(value: authService.isAnonymous);
